...
import com.ateneacloud.drive.account.SupportAccountManager;
...
public final class SettingsManager {
    ...
    public static final String SETTINGS_ACCOUNT_PLAN_KEY = "account_info_plan_key";
    ...
    // Synchronization
    public static final String SYNC_CATEGORY_KEY = "category_syncs_key";
    public static final String CLIENT_SYNCS_KEY = "client_syncs_key";
    public static final String PERFORM_SYNCS_KEY = "perform_syncs_key";
    ...
    // Camera upload
    public static final String PKG = "com.ateneacloud.drive";
    ...
    public String getCameraBackupEmail() {
