...
public class TransferService extends Service {
     ...
     *
     * @param uploadFile The UploadFile object containing information about the file to be uploaded.
     * @return
     */
    public int addTaskToUploadQue(UploadFile uploadFile) {
        return uploadTaskManager.addTaskToQue("", uploadFile, false);
    }

    public int addTaskToSourceQue(String source, UploadFile uploadFile) {
        return uploadTaskManager.addTaskToQue(source, uploadFile, false);
    }
    ...
    public int addTaskToUploadQueBlock(UploadFile uploadFile) {
        return uploadTaskManager.addTaskToQue("", uploadFile, true);
    }
     ...
     * @return
     */
    public int addUploadTask(UploadFile uploadFile) {
        return addTaskToUploadQue(uploadFile);
    }
    ...
    public int addCameraUploadTask(Account account, String repoID, String repoName, String dir,
        ...
        return addTaskToSourceQue(Utils.TRANSFER_PHOTO_TAG, new SeafUploadFile(account, repoID, repoName, dir, filePath, isUpdate, isCopyToLocal));
    }
     ...
     * <p>
     * Note: when deleting all tasks whose state is {@link com.ateneacloud.drive.transfer.TaskState#TRANSFERRING} in the queue,
     * other tasks left will never be executed, because they are all in the {@link com.ateneacloud.drive.transfer.TaskState#INIT} state.
