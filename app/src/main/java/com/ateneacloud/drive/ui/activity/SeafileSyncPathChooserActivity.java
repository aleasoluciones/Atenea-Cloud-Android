...
import com.ateneacloud.drive.ui.adapter.DirentsAdapter;
import com.ateneacloud.drive.ui.adapter.SeafAccountAdapter;
import com.ateneacloud.drive.ui.adapter.SeafReposAdapter;
 ...
 */
public class SeafileSyncPathChooserActivity extends BaseActivity implements Toolbar.OnMenuItemClickListener {
    ...
    private void chooseRepo(boolean forceRefresh) {
        ...
        if (!Utils.isNetworkOn() || !forceRefresh) {
            ...
            if (repos != null) {
                for (Iterator<SeafRepo> iterable = repos.iterator();  iterable.hasNext();) {
                    SeafRepo repo = iterable.next();
        ...
        protected void onPostExecute(Void v) {
            ...
            if (err != null) {
                ...
                if (retCode == SeafConnection.HTTP_STATUS_REPO_PASSWORD_REQUIRED) {
                    ...
                    showShortToast(SeafileSyncPathChooserActivity.this, message);
                } else {
