...
import com.ateneacloud.drive.ui.adapter.StarredItemAdapter;
...
import com.ateneacloud.drive.util.SupportAsyncTask;
    ...
    private void showLoading(boolean show) {
        ...
        if (show) {
            ...
            try {
                ...
                Log.d("L205 - StarredFragment", "NullPointerException showLoading");
            }
        }
    }
