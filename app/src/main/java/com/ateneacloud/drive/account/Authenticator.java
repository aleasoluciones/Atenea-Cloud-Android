...
import com.ateneacloud.drive.account.ui.SeafileAuthenticatorActivity;
...
public class Authenticator extends AbstractAccountAuthenticator {
    ...
    private com.ateneacloud.drive.account.AccountManager manager;
    ...
    public Authenticator(Context context) {
        ...
        this.manager = new com.ateneacloud.drive.account.AccountManager(context);
    }
