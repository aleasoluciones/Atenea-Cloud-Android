...
import com.ateneacloud.drive.ui.EmailAutoCompleteTextView;
import com.ateneacloud.drive.ui.activity.AccountsActivity;
import com.ateneacloud.drive.ui.activity.BaseActivity;
import com.ateneacloud.drive.ui.dialog.PolicyPolityDialog;
            ...
            PolicyPolityDialog dialog = new PolicyPolityDialog(this, new PolicyPolityDialog.OnCloseListener() {
                ...
                public void onClose(boolean accepted) {
                    if (accepted) {
                        ...
                        finishAffinity(); // Esto termina todas las actividades en la pila de tareas
                    }
                    // Llamar al callback independientemente de si se aceptó o no la política
                    callback.onPolicyVerified(true);
                }
...
//        if (!NetworkUtils.isConnected()) {
        ...
        Account tmpAccount = new Account(null, serverURL, email, null, false, mSessionKey);
         ...
         mProgressDialog.setCancelable(false);
                ...
                // Una vez que la política se haya verificado (o si ya estaba aceptada), iniciar la tarea asíncrona
